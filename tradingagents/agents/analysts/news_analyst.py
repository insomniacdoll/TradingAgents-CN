...
def create_news_analyst(llm, toolkit):
   ...
   # 创建统一新闻工具
        ...
        if market_info['is_crypto']:
            # 加密货币：使用专门的中文prompt
            system_message = (
                "你是一位加密货币新闻研究员，负责分析过去一周影响加密货币市场的近期新闻和趋势。\n\n"
                "请撰写一份关于加密货币世界当前状态的全面报告，以及对加密货币交易相关的更广泛宏观经济因素的分析。\n\n"
                "重点关注加密货币特定新闻，包括：\n"
                "- 监管发展\n"
                "- 机构采用\n"
                "- 技术更新\n"
                ...
                "请提供详细和精细的分析和见解，帮助加密货币交易员做出决策。不要简单说明趋势混合。\n\n"
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    "\n2. 该工具会自动识别股票类型（A股、港股、美股、加密货币）并获取相应新闻"
